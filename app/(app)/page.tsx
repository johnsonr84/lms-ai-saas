      ...
      <main className="relative z-10">
        <section className="px-6 lg:px-12 pt-16 pb-24 max-w-7xl mx-auto">
          <div className="flex flex-col items-center text-center">
            ...
            >
              <span className="block text-black">Master coding</span>
            ...
            {/* Subheadline */}
            <p
              className="text-lg md:text-xl text-zinc-500 max-w-2xl mb-10 leading-relaxed animate-fade-in"
                ...
                <>
                  ...
                  <Link href="/dashboard/courses">
                    <Button
                      variant="outline"
                      size="lg"
                      className="border-zinc-700 bg-zinc-500 text-white px-8 h-12 text-base hover:bg-black hover:text-white"
                    >
                ...
                <>
                  ...
                  <Link href="/dashboard">
                    <Button
                      variant="outline"
                      size="lg"
                      className="border-zinc-500 bg-white/5 text-black px-8 h-12 text-base hover:bg-zinc-900 hover:text-white"
                    >
                      <BookOpen className="w-4 h-4 mr-2" />
                      Browse Courses
                    </Button>
        ...
        <section className="px-6 lg:px-12 py-20 max-w-7xl mx-auto">
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              >
                {plan.popular && (
                  <div className="absolute -top-3 left-1/2 -translate-x-1/2 px-3 py-1 rounded-full bg-gradient-to-r from-violet-500 to-fuchsia-500 text-xs font-semibold text-white">
                    Most Popular
                  </div>
                )}
                <div
        ...
        <section id="courses" className="px-6 lg:px-12 py-20 max-w-7xl mx-auto">
          ...
          <div className="text-center mt-10">
            <Link href="/dashboard">
              <Button
                variant="outline"
                className="bg-gradient-to-r from-violet-600 to-fuchsia-600 hover:from-violet-500 hover:to-fuchsia-500  text-white hover:text-white border-0 shadow-xl shadow-violet-600/30 px-10 h-14 text-lg font-semibold"
              >
                View All Courses
            ...
            {[
              {
                ...
                content:
                  "DevDork's content is incredible. I went from knowing nothing to landing my first dev job in 6 months!",
                avatar: "🧑‍💻",
              },
              {
                name: "Sarah Miller",
              ...
              },
              {
                ...
                content:
                  "Best investment I've made. The Pro courses filled gaps my bootcamp courses never covered.",
                avatar: "🎓",
              },
            ].map((testimonial) => (
              <div
                key={testimonial.name}
                className="p-6 rounded-2xl bg-zinc-100/10 border border-zinc-400"
              >
                ...
                <p className="bg-gradient-to-br from-violet-700 to-cyan-500 bg-clip-text text-transparent mb-6 leading-relaxed">
        ...
        {/* CTA Section */}
        <section className="px-6 lg:px-12 py-20 max-w-7xl mx-auto">
          <div className="relative rounded-3xl bg-gradient-to-br from-violet-600/20 via-fuchsia-600/10 to-cyan-600/20 border border-violet-400 p-12 md:p-20 text-center overflow-hidden">
        ...
        <footer className="px-6 lg:px-12 py-12 border-t border-zinc-800/50 max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="flex items-center gap-3">
              ...
              <span className="font-bold">DevDork&apos;s Academy</span>
            </div>
            ...
            <p className="text-sm text-zinc-600">
              © {new Date().getFullYear()} DevDork&apos;s Academy. All rights reserved.
            </p>
          </div>
        </footer>
      </main>
