      ...
      <main className="relative z-10 px-6 lg:px-12 py-12 max-w-7xl mx-auto">
        ...
        <div className="mb-12">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-4">
            <h1 className="text-4xl md:text-5xl text-black font-black tracking-tight">
              Welcome back,{" "}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-12">
          <div className="p-6 rounded-xl bg-black border border-zinc-800">
            <div className="flex items-center gap-3 mb-2">
              <div className="w-10 h-10 rounded-lg bg-violet-500/50 flex items-center justify-center">
                <BookOpen className="w-5 h-5 text-violet-400" />
              </div>
              <div>
                <p className="text-2xl font-bold text-white">{courses.length}</p>
                <p className="text-sm text-zinc-100">Available Courses</p>
              </div>
            </div>
          </div>
          ...
          <div className="p-6 rounded-xl bg-black border border-zinc-800">
            <div className="flex items-center gap-3 mb-2">
              <div className="w-10 h-10 rounded-lg bg-emerald-500/40 flex items-center justify-center">
                <Sparkles className="w-5 h-5 text-emerald-400" />
              </div>
              <div>
                <p className="text-2xl font-bold text-white capitalize">{userTier}</p>
                <p className="text-sm text-zinc-100">Current Plan</p>
              </div>
            </div>
          </div>
