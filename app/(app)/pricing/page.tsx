    ...
    <div className="min-h-screen bg-white overflow-hidden">
      ...
      <main className="relative z-10 px-6 lg:px-12 py-12 max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <h1 className="text-4xl md:text-6xl text-black tracking-tight mb-6">
            Choose your{" "}
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-16">
          {TIER_FEATURES.map((plan) => {
            ...
            return (
              <div
                key={plan.tier}
                className={`p-6 rounded-xl bg-zinc-200/30 border ${colorClasses.border}`}
              >
                ...
                <ul className="space-y-3">
                  {plan.features.map((feature) => (
                    <li
                      key={feature}
                      className="flex items-start gap-2 text-sm text-zinc-500 font-bold"
                    >
                      <CheckCircle2
        ...
        <div className="mt-16 text-center">
          <p className="text-zinc-500">
            ...
            <Link
              href="#"
              className="text-violet-500 hover:text-violet-300 underline underline-offset-4"
            >
              Contact us
            </Link>{" "}
            or check out our{" "}
