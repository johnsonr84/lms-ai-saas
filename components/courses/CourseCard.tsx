...
export function CourseCard({
  ...
  return (
    <Link href={linkHref} className="group block">
      <div className="relative rounded-2xl bg-white border border-zinc-300 overflow-hidden hover:border-zinc-700 transition-all duration-300 hover:shadow-lg hover:shadow-violet-500/5">
        ...
        {/* Course content */}
        <div className="p-5">
          <h3 className="text-lg font-bold mb-2 text-black group-hover:text-violet-500 transition-colors line-clamp-2">
