...
export function CourseCompleteButton({
  ...
  return (
    <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 p-4 bg-violet-500/20 border border-zinc-800 rounded-xl">
      <div className="flex items-center gap-3 flex-1">
        <div className="flex items-center justify-center w-14 h-14 rounded-full bg-white shrink-0">
          <span className="text-base font-bold text-violet-400">
            {progressPercent}%
          </span>
        </div>
        <div>
          <p className="font-semibold text-black">Your Progress</p>
