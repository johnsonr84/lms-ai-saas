          ...
          {showSearch && (
            <div className="relative w-full sm:w-72">
              ...
              <Input
                ...
                className="pl-10 bg-white border-zinc-400 text-white placeholder:text-zinc-500 focus-visible:ring-violet-500"
              />
            </div>
          )}
        </div>
        ...
        <div className="flex flex-col items-center justify-center py-16 text-center">
          ...
          {(tierFilter !== "all" || searchQuery) && (
            <button
              ...
              className="mt-2 text-sm text-violet-600 hover:text-violet-300 transition-colors"
            >
              Clear filters
            </button>
          )}
