      ...
      <div className="flex-1 min-w-0">
        {hasAccess ? (
          <>
            ...
            {/* Lesson Content */}
            {lesson.content && (
              <div className="bg-zinc-200 border border-zinc-500 rounded-xl p-6 md:p-8 mb-6">
            ...
            <div className="flex items-center justify-between pt-6 border-t border-zinc-800">
              {prevLesson ? (
                <Link href={`/lessons/${prevLesson.slug}`}>
                  <Button
                    variant="ghost"
                    className="text-zinc-500 bg-black text-white hover:text-black hover:bg-zinc-300 border border:zinc-800 hover:border-violet-600"
                  >
