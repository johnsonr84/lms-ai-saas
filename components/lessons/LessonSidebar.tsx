...
export function LessonSidebar({
  ...
  return (
    <div className="w-full lg:w-80 shrink-0">
      <div className="sticky top-24 bg-zinc-900/80 border border-zinc-700 rounded-xl overflow-hidden">
        {/* Course header */}
        <div className="p-4 border-b bg-black border-zinc-100">
          <Link
          ...
          <h3 className="text-xl font-bold block bg-gradient-to-r from-violet-400 via-fuchsia-400 to-cyan-400 bg-clip-text text-transparent mt-2 line-clamp-2">
            {courseTitle ?? "Course"}
          </h3>
        </div>
                ...
                >
                  <AccordionTrigger className="px-4 py-3 hover:no-underline hover:bg-zinc-800/50 text-left">
                    <div className="flex items-center gap-3 flex-1 min-w-0">
                      <span className="flex items-center justify-center w-6 h-6 rounded bg-fuchsia-500 text-white text-xs font-bold shrink-0">
                        {moduleIndex + 1}
                      </span>
                      <div className="min-w-0 flex-1">
                        <div className="flex items-center gap-2">
                          <span className="text-xs text-zinc-200 uppercase tracking-wider">
                            Module
                          </span>
                        </div>
                  ...
                  <AccordionContent className="pb-3 pt-1">
                    <div className="ml-4 border-l-2 border-zinc-400 pl-3 space-y-1">
